...
function getEditorURL(example) {
  ...
  let editorUrl = _path + "editor-es5.html?id=" + _id;
...
function createGalleryChart(example) {
  ...
  let thumbnail = (window.thumbnailPath || "../config/thumbnail/") + (example.thumbnail || example.main_es5 + ".jpg");
